package com.example.mrokey.besttrip.features.home
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_manage -> {
                Toast.makeText(this@MainActivity, "manage", Toast.LENGTH_SHORT).show()
            }
            R.id.nav_taxi -> {
                Toast.makeText(this@MainActivity, "taxi", Toast.LENGTH_SHORT).show()
            }
            R.id.nav_logout -> {
